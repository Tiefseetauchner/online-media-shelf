    ...
    state.shelf == undefined ?
      ...
      <>
        <AddItemToShelfDialog
          ...
          onCreateItem={() => setState(prevState => ({
            ...prevState,
        ...
        <CreateItemDialog
          onOpenChange={(_, data) => setState(prevState => ({
            ...prevState,
            isCreateItemDialogOpen: data.open
          }))}
          open={state.isCreateItemDialogOpen}
          afterActionComplete={(result) => {
            async function addItemToShelf() {
              const client = new ShelfClient();

              await client.addItem(state.shelf?.id!, new ItemAddModel({id: result?.id}))
