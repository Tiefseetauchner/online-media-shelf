...
import SearchField, {SuggestionType} from "../SearchField.tsx";
import {IShelfModel, ItemAddModel, ShelfClient} from "../../OMSWebClient.ts";
          ...
          <DialogContent
            ...
            <Field
              ...
              <SearchField<IShelfModel>
                ...
                value={state.selectedShelfTitle ?? "empty!!!"}/>
            </Field>
          </DialogContent>
        </DialogBody>
